...
export default {
    ...
    return {
      ...
      alarmMapping: {
        ...
        'DB101.DBW1002': {
          ...
          bit9: '预热前小车行走电机启动故障',
          bit10: '预热前小车变频器故障',
          bit11: '预热前小车输送1电机运行超时故障',
          bit12: '预热前小车输送2电机运行超时故障',
          bit13: '预热前小车前进接货停靠故障',
          bit14: '预热前小车前进送货停靠故障',
          bit15: '预热前小车后退接货停靠故障'
        },
        'DB101.DBW1004': {
          bit0: '1#预热房1-1#电机运行故障',
          bit1: '1#预热房1-1#自动进出货运行超时故障',
          bit2: '1#预热房1-2#电机启动故障',
          bit3: '1#预热房1-2#电机运行故障',
          bit4: '1#预热房1-2#自动进出货运行超时故障',
          bit5: '1#预热房2-1#电机启动故障',
          bit6: '1#预热房2-1#电机运行故障',
          bit7: '1#预热房2-1#自动进出货运行超时故障',
          bit8: '预热前区急停按钮被按下',
          bit9: '预热后区急停按钮被按下',
          bit10: '柜门急停按钮被按下',
          bit11: '1#预热房1#线数量超限',
        ...
        'DB101.DBW1006': {
          ...
          bit6: '',
          bit7: '',
          bit8: '1#预热房2-2#电机启动故障',
          bit9: '1#预热房2-2#电机运行故障',
          bit10: '1#预热房2-2#自动进出货运行超时故障',
          bit11: '1#预热房就地操作站急停按钮被按下',
          bit12: '',
          bit13: '',
          bit14: '',
          bit15: ''
        ...
        'DB101.DBW1008': {
          ...
          bit1: 'B过渡1线电机启动故障',
          bit2: 'B过渡1线电机运行故障',
          bit3: 'B过渡1线自动进出货运行超时故障',
          bit4: '',
          bit5: '',
          bit6: 'B过渡电机过载故障',
          bit7: 'B灭菌柜就地操作站急停按钮被按下',
          bit8: 'B灭菌柜1线电机启动故障',
          bit9: 'B灭菌柜1线电机抱闸启动故障',
          bit10: 'B灭菌柜1线电机运行故障',
          bit11: 'B灭菌柜1线自动进出货运行超时故障',
          bit12: 'B灭菌柜1线变频器故障',
          bit13: 'B灭菌柜1线数量超限',
          bit14: '灭菌前区分站急停按钮被按下',
          bit15: '灭菌后区分站急停按钮被按下'
        ...
        'DB101.DBW1012': {
          bit0: '2#预热房1-1#电机运行故障',
          bit1: '2#预热房1-1#自动进出货运行超时故障',
          bit2: '2#预热房1-2#电机启动故障',
          bit3: '2#预热房1-2#电机运行故障',
          bit4: '2#预热房1-2#自动进出货运行超时故障',
          bit5: '2#预热房2-1#电机启动故障',
          bit6: '2#预热房2-1#电机运行故障',
          bit7: '2#预热房2-1#自动进出货运行超时故障',
          bit8: '',
          bit9: '',
          bit10: '',
          bit11: '2#预热房1#线数量超限',
        ...
        'DB101.DBW1014': {
          ...
          bit6: '',
          bit7: '',
          bit8: '2#预热房2-2#电机启动故障',
          bit9: '2#预热房2-2#电机运行故障',
          bit10: '2#预热房2-2#自动进出货运行超时故障',
          bit11: '2#预热房就地操作站急停按钮被按下',
          bit12: '',
          bit13: '',
          bit14: '',
          bit15: ''
        ...
        'DB101.DBW1016': {
          ...
          bit1: 'C过渡1线电机启动故障',
          bit2: 'C过渡1线电机运行故障',
          bit3: 'C过渡1线自动进出货运行超时故障',
          bit4: '',
          bit5: '',
          bit6: 'C过渡电机过载故障',
          bit7: 'C灭菌柜就地操作站急停按钮被按下',
          bit8: 'C灭菌柜1线电机启动故障',
          bit9: 'C灭菌柜1线电机抱闸启动故障',
          bit10: 'C灭菌柜1线电机运行故障',
          bit11: 'C灭菌柜1线自动进出货运行超时故障',
          bit12: 'C灭菌柜1线变频器故障',
          bit13: 'C灭菌柜1线数量超限',
          bit14: '',
          bit15: ''
        ...
        'DB101.DBW1020': {
          bit0: '3#预热房1-1#电机运行故障',
          bit1: '3#预热房1-1#自动进出货运行超时故障',
          bit2: '3#预热房1-2#电机启动故障',
          bit3: '3#预热房1-2#电机运行故障',
          bit4: '3#预热房1-2#自动进出货运行超时故障',
          bit5: '3#预热房2-1#电机启动故障',
          bit6: '3#预热房2-1#电机运行故障',
          bit7: '3#预热房2-1#自动进出货运行超时故障',
          bit8: '',
          bit9: '',
          bit10: '',
          bit11: '3#预热房1#线数量超限',
        ...
        'DB101.DBW1022': {
          ...
          bit6: '',
          bit7: '',
          bit8: '3#预热房2-2#电机启动故障',
          bit9: '3#预热房2-2#电机运行故障',
          bit10: '3#预热房2-2#自动进出货运行超时故障',
          bit11: '3#预热房就地操作站急停按钮被按下',
          bit12: '',
          bit13: '',
          bit14: '',
          bit15: ''
        ...
        'DB101.DBW1024': {
          ...
          bit1: '3#过渡1线电机启动故障',
          bit2: 'D过渡1线电机运行故障',
          bit3: 'D过渡1线自动进出货运行超时故障',
          bit4: '',
          bit5: '',
          bit6: 'D过渡电机过载故障',
          bit7: 'D灭菌柜就地操作站急停按钮被按下',
          bit8: 'D灭菌柜1线电机启动故障',
          bit9: 'D灭菌柜1线电机抱闸启动故障',
          bit10: 'D灭菌柜1线电机运行故障',
          bit11: 'D灭菌柜1线自动进出货运行超时故障',
          bit12: 'D灭菌柜1线变频器故障',
          bit13: 'D灭菌柜1线数量超限',
          bit14: '',
          bit15: ''
        ...
        'DB101.DBW1028': {
          bit0: '4#预热房1-1#电机运行故障',
          bit1: '4#预热房1-1#自动进出货运行超时故障',
          bit2: '4#预热房1-2#电机启动故障',
          bit3: '4#预热房1-2#电机运行故障',
          bit4: '4#预热房1-2#自动进出货运行超时故障',
          bit5: '4#预热房2-1#电机启动故障',
          bit6: '4#预热房2-1#电机运行故障',
          bit7: '4#预热房2-1#自动进出货运行超时故障',
          bit8: '',
          bit9: '',
          bit10: '',
          bit11: '4#预热房1#线数量超限',
        ...
        'DB101.DBW1030': {
          ...
          bit6: '',
          bit7: '',
          bit8: '4#预热房2-2#电机启动故障',
          bit9: '4#预热房2-2#电机运行故障',
          bit10: '4#预热房2-2#自动进出货运行超时故障',
          bit11: '4#预热房就地操作站急停按钮被按下',
          bit12: '',
          bit13: '',
          bit14: '',
          bit15: ''
        ...
        'DB101.DBW1032': {
          ...
          bit1: 'E过渡1线电机启动故障',
          bit2: 'E过渡1线电机运行故障',
          bit3: 'E过渡1线自动进出货运行超时故障',
          bit4: '',
          bit5: '',
          bit6: 'E过渡电机过载故障',
          bit7: 'E灭菌柜就地操作站急停按钮被按下',
          bit8: 'E灭菌柜1线电机启动故障',
          bit9: 'E灭菌柜1线电机抱闸启动故障',
          bit10: 'E灭菌柜1线电机运行故障',
          bit11: 'E灭菌柜1线自动进出货运行超时故障',
          bit12: 'E灭菌柜1线变频器故障',
          bit13: 'E灭菌柜1线数量超限',
          bit14: '',
          bit15: ''
        ...
        'DB101.DBW1036': {
          bit0: '5#预热房1-1#电机运行故障',
          bit1: '5#预热房1-1#自动进出货运行超时故障',
          bit2: '5#预热房1-2#电机启动故障',
          bit3: '5#预热房1-2#电机运行故障',
          bit4: '5#预热房1-2#自动进出货运行超时故障',
          bit5: '5#预热房2-1#电机启动故障',
          bit6: '5#预热房2-1#电机运行故障',
          bit7: '5#预热房2-1#自动进出货运行超时故障',
          bit8: '',
          bit9: '',
          bit10: '',
          bit11: '5#预热房1#线数量超限',
        ...
        'DB101.DBW1038': {
          ...
          bit6: '',
          bit7: '',
          bit8: '5#预热房2-2#电机启动故障',
          bit9: '5#预热房2-2#电机运行故障',
          bit10: '5#预热房2-2#自动进出货运行超时故障',
          bit11: '5#预热房就地操作站急停按钮被按下',
          bit12: '',
          bit13: '',
          bit14: '',
          bit15: ''
        ...
        'DB101.DBW1040': {
          ...
          bit1: 'F过渡1线电机启动故障',
          bit2: 'F过渡1线电机运行故障',
          bit3: 'F过渡1线自动进出货运行超时故障',
          bit4: '',
          bit5: '',
          bit6: 'F过渡电机过载故障',
          bit7: 'F灭菌柜就地操作站急停按钮被按下',
          bit8: 'F灭菌柜1线电机启动故障',
          bit9: 'F灭菌柜1线电机抱闸启动故障',
          bit10: 'F灭菌柜1线电机运行故障',
          bit11: 'F灭菌柜1线自动进出货运行超时故障',
          bit12: 'F灭菌柜1线变频器故障',
          bit13: 'F灭菌柜1线数量超限',
          bit14: '',
          bit15: ''
        ...
        'DB101.DBW1044': {
          bit0: '6#预热房1-1#电机运行故障',
          bit1: '6#预热房1-1#自动进出货运行超时故障',
          bit2: '6#预热房1-2#电机启动故障',
          bit3: '6#预热房1-2#电机运行故障',
          bit4: '6#预热房1-2#自动进出货运行超时故障',
          bit5: '6#预热房2-1#电机启动故障',
          bit6: '6#预热房2-1#电机运行故障',
          bit7: '6#预热房2-1#自动进出货运行超时故障',
          bit8: '',
          bit9: '',
          bit10: '',
          bit11: '6#预热房1#线数量超限',
        ...
        'DB101.DBW1046': {
          ...
          bit6: '',
          bit7: '',
          bit8: '6#预热房2-2#电机启动故障',
          bit9: '6#预热房2-2#电机运行故障',
          bit10: '6#预热房2-2#自动进出货运行超时故障',
          bit11: '6#预热房就地操作站急停按钮被按下',
          bit12: '',
          bit13: '',
          bit14: '',
          bit15: ''
        ...
        'DB101.DBW1048': {
          ...
          bit1: 'G过渡1线电机启动故障',
          bit2: 'G过渡1线电机运行故障',
          bit3: 'G过渡1线自动进出货运行超时故障',
          bit4: '',
          bit5: '',
          bit6: 'G过渡电机过载故障',
          bit7: 'G灭菌柜就地操作站急停按钮被按下',
          bit8: 'G灭菌柜1线电机启动故障',
          bit9: 'G灭菌柜1线电机抱闸启动故障',
          bit10: 'G灭菌柜1线电机运行故障',
          bit11: 'G灭菌柜1线自动进出货运行超时故障',
          bit12: 'G灭菌柜1线变频器故障',
          bit13: 'G灭菌柜1线数量超限',
          bit14: '',
          bit15: ''
        ...
        'DB101.DBW1052': {
          bit0: '7#预热房1-1#电机运行故障',
          bit1: '7#预热房1-1#自动进出货运行超时故障',
          bit2: '7#预热房1-2#电机启动故障',
          bit3: '7#预热房1-2#电机运行故障',
          bit4: '7#预热房1-2#自动进出货运行超时故障',
          bit5: '7#预热房2-1#电机启动故障',
          bit6: '7#预热房2-1#电机运行故障',
          bit7: '7#预热房2-1#自动进出货运行超时故障',
          bit8: '',
          bit9: '',
          bit10: '',
          bit11: '7#预热房1#线数量超限',
        ...
        'DB101.DBW1054': {
          ...
          bit6: '',
          bit7: '',
          bit8: '7#预热房2-2#电机启动故障',
          bit9: '7#预热房2-2#电机运行故障',
          bit10: '7#预热房2-2#自动进出货运行超时故障',
          bit11: '7#预热房就地操作站急停按钮被按下',
          bit12: '',
          bit13: '',
          bit14: '',
          bit15: ''
        ...
        'DB101.DBW1056': {
          ...
          bit1: 'H过渡1线电机启动故障',
          bit2: 'H过渡1线电机运行故障',
          bit3: 'H过渡1线自动进出货运行超时故障',
          bit4: '',
          bit5: '',
          bit6: 'H过渡电机过载故障',
          bit7: 'H灭菌柜就地操作站急停按钮被按下',
          bit8: 'H灭菌柜1线电机启动故障',
          bit9: 'H灭菌柜1线电机抱闸启动故障',
          bit10: 'H灭菌柜1线电机运行故障',
          bit11: 'H灭菌柜1线自动进出货运行超时故障',
          bit12: 'H灭菌柜1线变频器故障',
          bit13: 'H灭菌柜1线数量超限',
          bit14: '',
          bit15: ''
        ...
        'DB101.DBW1062': {
          ...
          bit9: '灭菌前小车行走电机启动故障',
          bit10: '灭菌前小车变频故障',
          bit11: '灭菌前小车输送1电机运行超时故障',
          bit12: '灭菌前小车输送2电机运行超时故障',
          bit13: '灭菌前小车前进接货停靠故障',
          bit14: '灭菌前小车前进送货停靠故障',
          bit15: '灭菌前小车后退接货停靠故障'
        },
        ...
        'DB101.DBW1066': {
          ...
          bit9: '灭菌后小车行走电机启动故障',
          bit10: '灭菌后小车变频故障',
          bit11: '灭菌后小车输送1电机运行超时故障',
          bit12: '灭菌后小车输送2电机运行超时故障',
          bit13: '灭菌后小车前进停接货靠故障',
          bit14: '灭菌后小车前进送货停靠故障',
          bit15: '灭菌后小车后退接货停靠故障'
        },
        'DB101.DBW1068': {
          ...
          bit8: '提升机1，升降电机启动故障',
          bit9: '提升机1，升降电机运行故障',
          bit10: '提升机1，升降电机抱闸启动故障',
          bit11: '提升机1，轿厢电机启动故障',
          bit12: '提升机1，轿厢电机运行故障',
          bit13: '提升机1，轿厢自动进出货运行超时故障',
          bit14: '提升机1，一楼门安全故障',
          bit15: '提升机1，二楼门安全故障'
        },
        'DB101.DBW1070': {
          ...
          bit8: '提升机2，升降电机启动故障',
          bit9: '提升机2，升降电机运行故障',
          bit10: '提升机2，升降电机抱闸启动故障',
          bit11: '提升机2，轿厢电机启动故障',
          bit12: '提升机2，轿厢电机运行故障',
          bit13: '提升机2，轿厢自动进出货运行超时故障',
          bit14: '提升机2，一楼门安全故障',
          bit15: '提升机2，二楼门安全故障'
        },
        'DB101.DBW1072': {
          ...
          bit9: 'A2103_电机运行故障',
          bit10: 'A2103_电机热过载故障',
          bit11: 'A2103_光电异常/无货物信息',
          bit12: 'A2103_光电异常/2',
          bit13: 'A2103_本级设备不在自动',
          bit14: 'A2103_进货过程中断故障',
          bit15: 'A2103_出货过程中断故障'
        },
        'DB101.DBW1074': {
          bit0: '',
          bit1: '',
          ...
          bit6: '',
          bit7: '',
          bit8: '与分站PLC通讯中断，请检查柜内网线',
          bit9: 'A2105处货物超宽（2103方向）',
          bit10: 'A2105处货物超宽（2115方向）',
          bit11: '',
          bit12: '',
          bit13: '',
          bit14: '',
        ...
        'DB101.DBW1076': {
          ...
          bit8: 'A2105_电机启动故障',
          bit9: 'A2105_电机运行超时故障',
          bit10: 'A2105_升降电机运行超时故障',
          bit11: 'A2105_移栽电机热过载故障',
          bit12: 'A2105_从动电机热过载故障',
          bit13: 'A2105_升降电机热过载故障',
          bit14: 'A2105_升降位置异常故障',
          bit15: 'A2105_光电异常/无货物信息'
        },
        'DB101.DBW1078': {
          bit0: '',
          bit1: '',
          ...
          bit6: '',
          bit7: '',
          bit8: '入库_2楼电柜1200PLC与1楼就地分柜smart200PLC通讯中断，请检查是否上电或网络连接',
          bit9: '入库_2楼电柜1200PLC与柜内smart200PLC通讯中断，请检查柜内网络连接',
          bit10:
            '入库_2楼电柜1200PLC与主控室1500PLC通讯中断，请检查现场就地分柜电箱是否上电或排查网线',
          bit11: '',
          bit12: '',
          bit13: '',
          bit14: '',
        ...
        'DB101.DBW1080': {
          ...
          bit3: '',
          bit4: '',
          bit5: '一楼入库A2107处，WCS下发托盘报警不允许出，请查看WCS报警内容。',
          bit6: '',
          bit7: '',
          bit8: 'A2107_电机启动故障',
          bit9: 'A2107_电机运行故障',
          bit10: 'A2107_电机热过载故障',
          bit11: 'A2107_光电异常/无货物信息',
          bit12: 'A2107_光电异常/2',
          bit13: 'A2107_本级设备不在自动',
          bit14: 'A2107_进货过程中断故障',
          bit15: 'A2107_出货过程中断故障'
        },
        'DB101.DBW1082': {
          bit0: '',
          bit1: '',
          ...
          bit9: 'A2108_电机运行故障',
          bit10: 'A2108_电机热过载故障',
          bit11: 'A2108_光电异常/无货物信息',
          bit12: 'A2108_光电异常/2',
          bit13: 'A2108_本级设备不在自动',
          bit14: 'A2108_进货过程中断故障',
          bit15: 'A2108_出货过程中断故障'
        },
        'DB101.DBW1084': {
          bit0: '',
          bit1: '',
          ...
          bit9: 'A2109_电机允许故障',
          bit10: 'A2109_电机热过载故障',
          bit11: 'A2109_光电异常/无货物信息',
          bit12: 'A2109_光电异常/2',
          bit13: 'A2109_本级设备不在自动',
          bit14: 'A2109_进货过程中断故障',
          bit15: 'A2109_出货过程中断故障'
        },
        'DB101.DBW1086': {
          bit0: '',
          bit1: '',
          ...
          bit9: 'A2110_电机运行故障',
          bit10: 'A2110_电机热过载故障',
          bit11: 'A2110_光电异常/无货物信息',
          bit12: 'A2110_光电异常/2',
          bit13: 'A2110_本级设备不在自动',
          bit14: 'A2110_进货过程中断故障',
          bit15: 'A2110_出货过程中断故障'
        },
        'DB101.DBW1088': {
          bit0: '',
          bit1: '',
          ...
          bit9: 'A2111_电机运行故障',
          bit10: 'A2111_电机热过载故障',
          bit11: 'A2111_光电异常/无货物信息',
          bit12: 'A2111_光电异常/2',
          bit13: 'A2111_本级设备不在自动',
          bit14: 'A2111_进货过程中断故障',
          bit15: 'A2111_出货过程中断故障'
        },
        'DB101.DBW1090': {
          bit0: '',
          bit1: '',
          ...
          bit9: 'A2112_电机运行故障',
          bit10: 'A2112_电机热过载故障',
          bit11: 'A2112_光电异常/无货物信息',
          bit12: 'A2112_光电异常/2',
          bit13: 'A2112_本级设备不在自动',
          bit14: 'A2112_进货过程中断故障',
          bit15: 'A2112_出货过程中断故障'
        },
        'DB101.DBW1092': {
          bit0: '',
          bit1: '',
          ...
          bit9: 'A2113_电机运行故障',
          bit10: 'A2113_电机热过载故障',
          bit11: 'A2113_光电异常/无货物信息',
          bit12: 'A2113_光电异常/2',
          bit13: 'A2113_本级设备不在自动',
          bit14: 'A2113_进货过程中断故障',
          bit15: 'A2113_出货过程中断故障'
        },
        'DB101.DBW1094': {
          bit0: '',
          bit1: '',
          ...
          bit9: 'A2114_电机运行故障',
          bit10: 'A2114_电机热过载故障',
          bit11: 'A2114_光电异常/无货物信息',
          bit12: 'A2114_光电异常/2',
          bit13: 'A2114_本级设备不在自动',
          bit14: 'A2114_进货过程中断故障',
          bit15: 'A2114_出货过程中断故障'
        },
        'DB101.DBW1096': {
          bit0: '',
          bit1: '',
          ...
          bit9: 'A2115_电机运行故障',
          bit10: 'A2115_电机热过载故障',
          bit11: 'A2115_光电异常/无货物信息',
          bit12: 'A2115_光电异常/2',
          bit13: 'A2115_本级设备不在自动',
          bit14: 'A2115_进货过程中断故障',
          bit15: 'A2115_出货过程中断故障'
        },
        'DB101.DBW1098': {
          bit0: 'A2117_光电异常/2',
          bit1: 'A2117_本级设备不在自动',
          ...
          bit8: 'A2117_电机启动故障',
          bit9: 'A2117_电机运行超时故障',
          bit10: 'A2117_升降电机运行超时故障',
          bit11: 'A2117_移栽电机热过载故障',
          bit12: 'A2117_从动电机热过载故障',
          bit13: 'A2117_升降电机热过载故障',
          bit14: 'A2117_升降位置异常故障',
          bit15: 'A2117_光电异常/无货物信息'
        },
        'DB101.DBW1100': {
          bit0: '',
          bit1: '',
          ...
          bit9: 'A2119_电机运行故障',
          bit10: 'A2119_电机热过载故障',
          bit11: 'A2119_光电异常/无货物信息',
          bit12: 'A2119_光电异常/2',
          bit13: 'A2119_本级设备不在自动',
          bit14: 'A2119_进货过程中断故障',
          bit15: 'A2119_出货过程中断故障'
        },
        'DB101.DBW1102': {
          bit0: '',
          bit1: '',
          ...
          bit9: 'A2120_电机运行故障',
          bit10: 'A2120_电机热过载故障',
          bit11: 'A2120_光电异常/无货物信息',
          bit12: 'A2120_光电异常/2',
          bit13: 'A2120_本级设备不在自动',
          bit14: 'A2120_进货过程中断故障',
          bit15: 'A2120_出货过程中断故障'
        },
        'DB101.DBW1104': {
          bit0: 'A2122_光电异常/2',
          bit1: 'A2122_本级设备不在自动',
          ...
          bit8: 'A2122_电机启动故障',
          bit9: 'A2122_电机运行超时故障',
          bit10: 'A2122_升降电机运行超时故障',
          bit11: 'A2122_移栽电机热过载故障',
          bit12: 'A2122_从动电机热故障故障',
          bit13: 'A2122_升降电机热过载故障',
          bit14: 'A2122_升降位置异常故障',
          bit15: 'A2122_光电异常/无货物信息'
        },
        'DB101.DBW1106': {
          bit0: '',
          bit1: '',
          ...
          bit3: '',
          bit4: '',
          bit5: '2#提升机_二楼出货口A2124处，WCS下发托盘报警不允许出，请查看WCS报警内容。',
          bit6: '',
          bit7: '',
          bit8: 'A2124_电机启动故障',
          bit9: 'A2124_电机运行故障',
          bit10: 'A2124_电机热过载故障',
          bit11: 'A2124_光电异常/无货物信息',
          bit12: 'A2124_光电异常/2',
          bit13: 'A2124_本级设备不在自动',
          bit14: 'A2124_进货过程中断故障',
          bit15: 'A2124_出货过程中断故障'
        },
        'DB101.DBW1108': {
          bit0: '',
          bit1: '',
          ...
          bit9: 'A2125_电机运行故障',
          bit10: 'A2125_电机热过载故障',
          bit11: 'A2125_光电异常/无货物信息',
          bit12: 'A2125_光电异常/2',
          bit13: 'A2125_本级设备不在自动',
          bit14: 'A2125_进货过程中断故障',
          bit15: 'A2125_出货过程中断故障'
        },
        'DB101.DBW1110': {
          bit0: '',
          bit1: '',
        ...
        'DB101.DBW1112': {
          ...
          bit9: 'A2127_电机运行故障',
          bit10: 'A2127_电机热过载故障',
          bit11: 'A2127_光电异常/无货物信息',
          bit12: 'A2127_光电异常/2',
          bit13: 'A2127_本级设备不在自动',
          bit14: 'A2127_进货过程中断故障',
          bit15: 'A2127_出货过程中断故障'
        },
        'DB101.DBW1114': {
          bit0: '',
          bit1: '',
          ...
          bit9: 'A2118_电机运行故障',
          bit10: 'A2118_电机热过载故障',
          bit11: 'A2118_光电异常/无货物信息',
          bit12: 'A2118_光电异常/2',
          bit13: 'A2118_本级设备不在自动',
          bit14: 'A2118_进货过程中断故障',
          bit15: 'A2118_出货过程中断故障'
        },
        'DB101.DBW1116': {
          bit0: '',
          bit1: '',
        ...
        'DB101.DBW1118': {
          ...
          bit6: '',
          bit7: '',
          bit8: '出库_2楼主柜内1200PLC与柜内smart200PLC通讯中断，请检查网络连接',
          bit9: '出库_1楼就地防爆分柜内smart200PLC与2楼主柜内PLC通讯中断，请检查网络连接。',
          bit10:
            '出库_主柜内1200PLC与主控室1500PLC通讯中断，请检查现场就地电箱是否上电。',
          bit11: '',
          bit12: '',
          bit13: '',
          bit14: '',
        ...
        'DB101.DBW1122': {
          ...
          bit3: 'A3005_进货过程中断故障 ',
          bit4: 'A3005_出货过程中断故障 ',
          bit5: '出库_1楼就地分柜处急停被拍下',
          bit6: '出库_2楼主柜处急停被拍下',
          bit7: '出库_2楼主柜处急停被拍下',
          bit8: 'A3005_电机启动故障 ',
          bit9: 'A3005_电机运行故障 ',
          bit10: 'A3005_升降电机运行超时故障',
          bit11: 'A3005_移栽电机热过载',
          bit12: 'A3005_附属链条机电机热过载',
          bit13: 'A3005_升降电机热过载',
          bit14: 'A3005_升降位置异常故障',
          bit15: 'A3005_光电异常/无货物信息 '
        },
        'DB101.DBW1124': {
          bit0: '',
          bit1: '',
          ...
          bit9: 'A3006_电机运行故障 ',
          bit10: 'A3006_电机热过载故障 ',
          bit11: 'A3006_光电异常/无货物信息 ',
          bit12: 'A3006_光电异常/2 ',
          bit13: 'A3006_本级设备不在自动 ',
          bit14: 'A3006_进货过程中断故障 ',
          bit15: 'A3006_出货过程中断故障 '
        },
        'DB101.DBW1126': {
          bit0: '',
          bit1: '',
          ...
          bit9: 'A3007_电机运行故障 ',
          bit10: 'A3007_电机热过载故障 ',
          bit11: 'A3007_光电异常/无货物信息 ',
          bit12: 'A3007_光电异常/2 ',
          bit13: 'A3007_本级设备不在自动 ',
          bit14: 'A3007_进货过程中断故障 ',
          bit15: 'A3007_出货过程中断故障 '
        },
        'DB101.DBW1128': {
          bit0: '',
          bit1: '',
          ...
          bit4: '',
          bit5: '',
          bit6: 'A3008处_WCS下发报警，托盘不允许出，请查看WCS报警内容。',
          bit7: '',
          bit8: 'A3008_电机启动故障 ',
          bit9: 'A3008_电机运行故障 ',
          bit10: 'A3008_电机热过载故障 ',
          bit11: 'A3008_光电异常/无货物信息 ',
          bit12: 'A3008_光电异常/2 ',
          bit13: 'A3008_本级设备不在自动 ',
          bit14: 'A3008_进货过程中断故障 ',
          bit15: 'A3008_出货过程中断故障 '
        },
        'DB101.DBW1130': {
          bit0: '',
          bit1: '',
        ...
        'DB101.DBW1132': {
          ...
          bit8: 'A3010_电机启动故障 ',
          bit9: 'A3010_电机运行超时故障 ',
          bit10: 'A3010_升降电机运行超时故障 ',
          bit11: 'A3010_移栽电机热过载故障 ',
          bit12: 'A3010_从动电机热过载故障 ',
          bit13: 'A3010_升降电机热过载故障 ',
          bit14: 'A3010_升降位置异常故障 ',
          bit15: 'A3010_光电异常/无货物信息 '
        },
        'DB101.DBW1134': {
          bit0: '',
          bit1: '',
          ...
          bit9: 'A3012_电机运行故障 ',
          bit10: 'A3012_电机热过载故障 ',
          bit11: 'A3012_光电异常/无货物信息 ',
          bit12: 'A3012_光电异常/2 ',
          bit13: 'A3012_本级设备不在自动 ',
          bit14: 'A3012_进货过程中断故障 ',
          bit15: 'A3012_出货过程中断故障 '
        },
        'DB101.DBW1136': {
          bit0: '',
          bit1: '',
          ...
          bit9: 'A3013_电机运行故障 ',
          bit10: 'A3013_电机热过载故障 ',
          bit11: 'A3013_光电异常/无货物信息 ',
          bit12: 'A3013_光电异常/2 ',
          bit13: 'A3013_本级设备不在自动 ',
          bit14: 'A3013_进货过程中断故障 ',
          bit15: 'A3013_出货过程中断故障 '
        },
        'DB101.DBW1138': {
          bit0: '',
          bit1: '',
          ...
          bit9: 'A3014_电机运行故障 ',
          bit10: 'A3014_电机热过载故障 ',
          bit11: 'A3014_光电异常/无货物信息 ',
          bit12: 'A3014_光电异常/2 ',
          bit13: 'A3014_本级设备不在自动 ',
          bit14: 'A3014_进货过程中断故障 ',
          bit15: 'A3014_出货过程中断故障 '
        },
        'DB101.DBW1140': {
          bit0: '',
          bit1: '',
          ...
          bit9: 'A3015_电机运行故障 ',
          bit10: 'A3015_电机热过载故障 ',
          bit11: 'A3015_光电异常/无货物信息 ',
          bit12: 'A3015_光电异常/2 ',
          bit13: 'A3015_本级设备不在自动 ',
          bit14: 'A3015_进货过程中断故障 ',
          bit15: 'A3015_出货过程中断故障 '
        },
        'DB101.DBW1142': {
          bit0: 'A3016_光电异常/2 ',
          bit1: 'A3016_本级设备不在自动 ',
          ...
          bit8: 'A3016_电机启动故障 ',
          bit9: 'A3016_电机运行超时故障 ',
          bit10: 'A3016_升降电机运行超时故障 ',
          bit11: 'A3016_移栽电机热过载故障 ',
          bit12: 'A3016_从动电机热过载故障 ',
          bit13: 'A3016_升降电机热过载故障 ',
          bit14: 'A3016_升降位置异常故障 ',
          bit15: 'A3016_光电异常/无货物信息 '
        },
        'DB101.DBW1144': {
          bit0: '',
          bit1: '',
          ...
          bit9: 'A3017_电机运行故障 ',
          bit10: 'A3017_电机热过载故障 ',
          bit11: 'A3017_光电异常/无货物信息 ',
          bit12: 'A3017_光电异常/2 ',
          bit13: 'A3017_本级设备不在自动 ',
          bit14: 'A3017_进货过程中断故障 ',
          bit15: 'A3017_出货过程中断故障 '
        },
        'DB101.DBW1146': {
          bit0: '',
          bit1: '',
        ...
        'DB101.DBW1148': {
          ...
          bit8: '出货提升机，升降电机启动故障',
          bit9: '出货提升机，升降电机运行故障',
          bit10: '出货提升机，升降电机抱闸启动故障',
          bit11: '出货提升机，轿厢电机启动故障',
          bit12: '出货提升机，轿厢电机运行故障',
          bit13: '出货提升机，轿厢自动进出货运行超时故障',
          bit14: '出货提升机，一楼门安全故障',
          bit15: '出货提升机，二楼门安全故障'
        }
      }
  ...
  mounted() {
    ...
    ipcRenderer.on('receivedMsg', (event, values, values2) => {
      ...
      this.alarmPoints.DBW1004 = Number(values.DBW1004 ?? 0);
      this.alarmPoints.DBW1006 = Number(values.DBW1006 ?? 0);
      this.alarmPoints.DBW1008 = Number(values.DBW1008 ?? 0);
      this.alarmPoints.DBW1010 = Number(values.DBW1010 ?? 0);
      this.alarmPoints.DBW1012 = Number(values.DBW1012 ?? 0);
      this.alarmPoints.DBW1014 = Number(values.DBW1014 ?? 0);
      this.alarmPoints.DBW1016 = Number(values.DBW1016 ?? 0);
      this.alarmPoints.DBW1018 = Number(values.DBW1018 ?? 0);
      this.alarmPoints.DBW1020 = Number(values.DBW1020 ?? 0);
      this.alarmPoints.DBW1022 = Number(values.DBW1022 ?? 0);
      this.alarmPoints.DBW1024 = Number(values.DBW1024 ?? 0);
      this.alarmPoints.DBW1026 = Number(values.DBW1026 ?? 0);
      this.alarmPoints.DBW1028 = Number(values.DBW1028 ?? 0);
      this.alarmPoints.DBW1030 = Number(values.DBW1030 ?? 0);
      this.alarmPoints.DBW1032 = Number(values.DBW1032 ?? 0);
      this.alarmPoints.DBW1034 = Number(values.DBW1034 ?? 0);
      this.alarmPoints.DBW1036 = Number(values.DBW1036 ?? 0);
      this.alarmPoints.DBW1038 = Number(values.DBW1038 ?? 0);
      this.alarmPoints.DBW1040 = Number(values.DBW1040 ?? 0);
      this.alarmPoints.DBW1042 = Number(values.DBW1042 ?? 0);
      this.alarmPoints.DBW1044 = Number(values.DBW1044 ?? 0);
      this.alarmPoints.DBW1046 = Number(values.DBW1046 ?? 0);
      this.alarmPoints.DBW1048 = Number(values.DBW1048 ?? 0);
      this.alarmPoints.DBW1050 = Number(values.DBW1050 ?? 0);
      this.alarmPoints.DBW1052 = Number(values.DBW1052 ?? 0);
      this.alarmPoints.DBW1054 = Number(values.DBW1054 ?? 0);
      this.alarmPoints.DBW1056 = Number(values.DBW1056 ?? 0);
      this.alarmPoints.DBW1058 = Number(values.DBW1058 ?? 0);
      this.alarmPoints.DBW1060 = Number(values.DBW1060 ?? 0);
      this.alarmPoints.DBW1062 = Number(values.DBW1062 ?? 0);
      this.alarmPoints.DBW1064 = Number(values.DBW1064 ?? 0);
      this.alarmPoints.DBW1066 = Number(values.DBW1066 ?? 0);
      this.alarmPoints.DBW1068 = Number(values.DBW1068 ?? 0);
      this.alarmPoints.DBW1070 = Number(values.DBW1070 ?? 0);
      this.alarmPoints.DBW1072 = Number(values.DBW1072 ?? 0);
      this.alarmPoints.DBW1074 = Number(values.DBW1074 ?? 0);
      this.alarmPoints.DBW1076 = Number(values.DBW1076 ?? 0);
      this.alarmPoints.DBW1078 = Number(values.DBW1078 ?? 0);
      this.alarmPoints.DBW1080 = Number(values.DBW1080 ?? 0);
      this.alarmPoints.DBW1082 = Number(values.DBW1082 ?? 0);
      this.alarmPoints.DBW1084 = Number(values.DBW1084 ?? 0);
      this.alarmPoints.DBW1086 = Number(values.DBW1086 ?? 0);
      this.alarmPoints.DBW1088 = Number(values.DBW1088 ?? 0);
      this.alarmPoints.DBW1090 = Number(values.DBW1090 ?? 0);
      this.alarmPoints.DBW1092 = Number(values.DBW1092 ?? 0);
      this.alarmPoints.DBW1094 = Number(values.DBW1094 ?? 0);
      this.alarmPoints.DBW1096 = Number(values.DBW1096 ?? 0);
      this.alarmPoints.DBW1098 = Number(values.DBW1098 ?? 0);
      this.alarmPoints.DBW1100 = Number(values.DBW1100 ?? 0);
      this.alarmPoints.DBW1102 = Number(values.DBW1102 ?? 0);
      this.alarmPoints.DBW1104 = Number(values.DBW1104 ?? 0);
      this.alarmPoints.DBW1106 = Number(values.DBW1106 ?? 0);
      this.alarmPoints.DBW1108 = Number(values.DBW1108 ?? 0);
      this.alarmPoints.DBW1110 = Number(values.DBW1110 ?? 0);
      this.alarmPoints.DBW1112 = Number(values.DBW1112 ?? 0);
      this.alarmPoints.DBW1114 = Number(values.DBW1114 ?? 0);
      this.alarmPoints.DBW1116 = Number(values.DBW1116 ?? 0);
      this.alarmPoints.DBW1118 = Number(values.DBW1118 ?? 0);
      this.alarmPoints.DBW1120 = Number(values.DBW1120 ?? 0);
      this.alarmPoints.DBW1122 = Number(values.DBW1122 ?? 0);
      this.alarmPoints.DBW1124 = Number(values.DBW1124 ?? 0);
      this.alarmPoints.DBW1126 = Number(values.DBW1126 ?? 0);
      this.alarmPoints.DBW1128 = Number(values.DBW1128 ?? 0);
      this.alarmPoints.DBW1130 = Number(values.DBW1130 ?? 0);
      this.alarmPoints.DBW1132 = Number(values.DBW1132 ?? 0);
      this.alarmPoints.DBW1134 = Number(values.DBW1134 ?? 0);
      this.alarmPoints.DBW1136 = Number(values.DBW1136 ?? 0);
      this.alarmPoints.DBW1138 = Number(values.DBW1138 ?? 0);
      this.alarmPoints.DBW1140 = Number(values.DBW1140 ?? 0);
      this.alarmPoints.DBW1142 = Number(values.DBW1142 ?? 0);
